...
class AddPasswordField extends StatefulWidget {
  final labelText;
  ...
  @override
  _AddPasswordFieldState createState() => _AddPasswordFieldState();
}

class _AddPasswordFieldState extends State<AddPasswordField> {
